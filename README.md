...
| <a name="input_log_forwarder_dead_letter_config"></a> [log\_forwarder\_dead\_letter\_config](#input\_log\_forwarder\_dead\_letter\_config) | Object of configuration values for forwarder Lambda function's dead letter queue | <pre>object({<br>    target_arn = string<br>  })</pre> | `null` | no |
...
| <a name="input_rds_em_forwarder_dead_letter_config"></a> [rds\_em\_forwarder\_dead\_letter\_config](#input\_rds\_em\_forwarder\_dead\_letter\_config) | Object of configuration values for the log forwarder Lambda function's dead letter queue | <pre>object({<br>    target_arn = string<br>  })</pre> | `null` | no |
...
| <a name="input_vpc_fl_forwarder_dead_letter_config"></a> [vpc\_fl\_forwarder\_dead\_letter\_config](#input\_vpc\_fl\_forwarder\_dead\_letter\_config) | Object of configuration values for log forwarder Lambda function's dead letter queue | <pre>object({<br>    target_arn = string<br>  })</pre> | `null` | no |
